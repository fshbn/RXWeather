...
/**
 ...
 - returns: Recorded event in time.
 */
public func completed<T>(_ time: TestTime, _: T.Type = T.self) -> Recorded<Event<T>> {
...
/**
 ...
 - parameter time: Recorded virtual time the `.completed` event occurs.
 */
public func error<T>(_ time: TestTime, _ error: Swift.Error, _: T.Type = T.self) -> Recorded<Event<T>> {
