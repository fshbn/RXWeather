...
//
    ...
    fileprivate var deallocatedSubjectContext: UInt8 = 0
        ...
        extension Reactive where Base: NSObject {
             ...
             */
            public func observe<E>(_: E.Type, _ keyPath: String, options: NSKeyValueObservingOptions = [.new, .initial], retainSelf: Bool = true) -> Observable<E?> {
        ...
        extension Reactive where Base: NSObject {
             ...
             **Since it needs to intercept object deallocation process it needs to perform swizzling of `dealloc` method on observed object.**
             ...
             - returns: Observable sequence of objects on `keyPath`.
             */
            public func observeWeakly<E>(_: E.Type, _ keyPath: String, options: NSKeyValueObservingOptions = [.new, .initial]) -> Observable<E?> {
