...
//
    ...
    extension Reactive where Base: NSObject {
         ...
         */
        public func observe<E: RawRepresentable>(_: E.Type, _ keyPath: String, options: NSKeyValueObservingOptions = [.new, .initial], retainSelf: Bool = true) -> Observable<E?> where E.RawValue: KVORepresentable {
        ...
        extension Reactive where Base: NSObject {
             ...
             */
            public func observeWeakly<E: RawRepresentable>(_: E.Type, _ keyPath: String, options: NSKeyValueObservingOptions = [.new, .initial]) -> Observable<E?> where E.RawValue: KVORepresentable {
