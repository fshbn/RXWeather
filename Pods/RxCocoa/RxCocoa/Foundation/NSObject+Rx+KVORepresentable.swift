...
//
    ...
    extension Reactive where Base: NSObject {
         ...
         */
        public func observe<E: KVORepresentable>(_: E.Type, _ keyPath: String, options: NSKeyValueObservingOptions = [.new, .initial], retainSelf: Bool = true) -> Observable<E?> {
        ...
        extension Reactive where Base: NSObject {
             ...
             */
            public func observeWeakly<E: KVORepresentable>(_: E.Type, _ keyPath: String, options: NSKeyValueObservingOptions = [.new, .initial]) -> Observable<E?> {
